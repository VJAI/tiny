...
exports.handle =
  ...
  exports.element =
    void 0;
const element_metadata_1 = require('./element.metadata');
 ...
 */
function element(name, tpl, shadow = false) {
  return target => {
...
function input(
  ...
  return (target, property) =>
    getMeta(target.constructor).inputs.add({ property, attribute, dataType });
}
exports.input = input;
/**
...
function query(selector) {
  return (target, property) =>
    getMeta(target.constructor).accessors.set(property, { selector });
}
exports.query = query;
/**
 * Decorator that helps to query and return DOM element(s) on accessing the applied property.
...
function queryAll(selector) {
  return (target, property) =>
    getMeta(target.constructor).accessors.set(property, {
      selector,
      all: true
    });
}
 ...
 */
function handle(eventName, element = 'self', all = false) {
