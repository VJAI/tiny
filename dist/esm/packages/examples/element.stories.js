...
var TodoApp = /** @class */ (function (_super) {
  ...
  __decorate([query('.list')], TodoApp.prototype, 'todosContainer', void 0);
  __decorate([query('input')], TodoApp.prototype, 'input', void 0);
  __decorate([handle('submit', 'form')], TodoApp.prototype, 'onSubmit', null);
  TodoApp = __decorate(
    [
      element(
        'todo-app',
...
var Todo = /** @class */ (function (_super) {
  ...
  __decorate([input(true)], Todo.prototype, 'item', void 0);
  __decorate([query('.text')], Todo.prototype, 'spanEl', void 0);
  __decorate([query('.delete')], Todo.prototype, 'deleteEl', void 0);
  __decorate([handle('click', '.delete')], Todo.prototype, 'onDelete', null);
  Todo = __decorate(
    [
      element(
        'todo-item',
